...
ggplot(sc_11_summary, aes(reorder(council, -any_care), any_care)) +
  ...
  coord_flip() +
  theme(panel.grid.major.y = element_line(ubdc_palette[18]),
        panel.grid.major.x = element_line(ubdc_palette[18])) +
  labs(
...
ggplot(pop_data_combined, 
  ...
  coord_flip() +
  theme(panel.grid.major.x = element_line(colour = ubdc_palette[18]),
        panel.grid.major.y = element_line(colour = ubdc_palette[18])) +
  labs(
...
ggplot(pop_data_combined, 
  ...
  geom_point(color = ubdc_palette[5], size = 3) +
  coord_flip() +
  theme(panel.grid.major.x = element_line(colour = ubdc_palette[16], size = 1),
        panel.grid.major.y = element_line(colour = ubdc_palette[16], size = 1)) +
  labs(
